...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href="http://www.omicseq.org:8080/index.html"><img id="search_logo" src="${ctx}/static/images/search_logo.png"></a>
			
			<div class="nav-collapse collapse">
				<ul class="nav">
					<li><a href="http://www.omicseq.org:8080/index.html"><fmt:message key="menu.home"/></a></li>
					<li><a href="${ctx}/testpages/about.htm"><fmt:message key="menu.about"/></a></li>
	...
	<div style="position: fixed; left:20px; top:45px;z-index:99;" xmlns="joy" id="joy-toobar" class="current_historybar">
		 <div class="div2 shrink" id="getCurrenthistory">
		 	<div class="div1"><img src="${ctx}/static/images/historyicon.png" />Recent Search</div>
		 </div>
	</div>
