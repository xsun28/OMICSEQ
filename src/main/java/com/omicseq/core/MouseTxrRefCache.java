 ...
 * 
 */
public class MouseTxrRefCache extends AbstractCache<String, List<TxrRef>> implements IInitializeable {
    private ITxrRefDAO txrRefDAO = DAOFactory.getDAOByTableType(ITxrRefDAO.class, "mouse");
    private static MouseTxrRefCache txrRefCache = new MouseTxrRefCache();
    // the first
    ...
    @Override
    public void doInit() {
        synchronized (MouseTxrRefCache.class) {
            Integer start = 0;
            Integer limit = 3000;
    ...
    public static void main(String[] args) {
        MouseTxrRefCache txrRefCache = new MouseTxrRefCache();
        txrRefCache.doInit();
    }
    ...
    public static MouseTxrRefCache getInstance() {
        return txrRefCache;
    }
