 ...
 * 
 */
public class GeneCache extends AbstractCache<String, Gene> implements IInitializeable {
	
    private IGeneDAO geneDAO = DAOFactory.getDAO(IGeneDAO.class);
    
    private static GeneCache geneCache = new GeneCache(false);
    ...
    private GeneCache(boolean lazy) {
        super(lazy);
    }
    ...
    public static void main(String[] args) {
        GeneCache geneCache = new GeneCache(false);
        geneCache.init();
        System.out.println(geneCache.getTssTesTotal());
    }

    public static GeneCache getInstance() {
        return geneCache;
    }
