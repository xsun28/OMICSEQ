...
public class PathWayStaticNewThread extends AbstractLifeCycle {
	...
	private static PathWayStaticNewThread single = new PathWayStaticNewThread();
	protected int threads = 8;
	
	private PathWayStaticNewThread() {
...
//		}
	...
	protected Callable<Object> getCallable() {
        return new CountCallable(new PathWayStaticNewThread());
    }
	...
	static class CountCallable extends BaseCallable<Object, PathWayStaticNewThread> {
        public CountCallable(PathWayStaticNewThread ref) {
            super(ref);
        }
        ...
        public Object call() throws Exception {
            ...
            try {
                ...
                query.put("pathId", new SmartDBObject("$gte", 9667));
