...
public class CalculatePathWayGeneRanks4 extends Thread {

	private Logger logger = LoggerFactory.getLogger(CalculatePathWayGeneRanks4.class);
...
//	private static ISampleDAO sampleDAO = DAOFactory.getDAOByTableType(ISampleDAO.class, "new");
	...
	public CalculatePathWayGeneRanks4(List<PathWay> plist) {
		this.plist = plist;
	}

	public CalculatePathWayGeneRanks4() {
...
//		query.addSort("mixturePerc", SortType.DESC);
	...
	public static void main(String[] args) {
		...
		CalculatePathWayGeneRanks4 thread = new CalculatePathWayGeneRanks4(plist);
		thread.start();
...
//		s.put("pathwayName", "LAU_APOPTOSIS_CDKN2A_DN");
		return pathWayDao.find(s, 8000, 3000);
	}
