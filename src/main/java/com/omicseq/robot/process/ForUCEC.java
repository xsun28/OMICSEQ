	...
	public void parser (){
		...
		for(String meFileName : meFileList){
			...
			try {
				...
				while((readLine = reader.readLine())!=null){
					...
					if(lineStrings.length>1){
						...
						if(flag){
							...
							System.out.println("TCGA-G9-6373-01A-11D-1787-05="+barCodes.indexOf("TCGA-FI-A3PV-01A-11D-A22B-05"));
							flag = false;
							//澧炲姞sample
				...
				for(int i=91; i<barCodes.size(); i++){
