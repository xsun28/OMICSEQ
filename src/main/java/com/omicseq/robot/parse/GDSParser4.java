...
//http://www.ncbi.nlm.nih.gov/gds/?term=human+rip-seq
 ...
 * @author zejun.du
 */
public class GDSParser4 extends BaseParser {
...
//    private String term = "(((\"%s\"[PDAT] : \"3000\"[PDAT]) AND \"Homo sapiens\"[Organism]) AND \"strategy chip seq\"[Properties]) AND \"sra gds\"[Filter]&cmd=DetailsSearch";
    private String term = "(\"humans\"[MeSH Terms] OR \"Homo sapiens\"[Organism] OR human[All Fields]) AND rip-seq[All Fields]";
    @Override
