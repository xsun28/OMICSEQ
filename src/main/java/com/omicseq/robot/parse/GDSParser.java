 ...
 * @author zejun.du
 */
public class GDSParser extends BaseParser {
...
//            url = url + "/?term=human+rna-seq";
            url = url +"/?term=rna-seq[All%20Fields]%20AND%20\"mouse\"[Organism]";
...
//            	query.put("sampleId", new SmartDBObject("$gt",600100));
