...
//http://www.ebi.ac.uk/arrayexpress/experiments/search.html?query=human+gro-seq&organism=&array=&exptype[]=&exptype[]=
 ...
 * @author zejun.du
 */
public class EBIParser3 extends BaseParser {
...
//            url = url + "/?term=%28%28%28%222014/01/01%22%5BPDAT%5D%20%3A%20%223000%22%5BPDAT%5D%29%20AND%20%22Homo%20sapiens%22%5BOrganism%5D%29%20AND%20%22strategy%20chip%20seq%22%5BProperties%5D%29%20AND%20%22sra%20gds%22%5BFilter%5D&cmd=DetailsSearch";
            url = url + "?query=gro-seq&organism=Homo+sapiens&array=&exptype[]=&exptype[]=";
//            url = url + "?query=gro-seq&organism=Mus+musculus&array=&exptype[]=&exptype[]=";  
...
//            process(doc.getElementsByClass("rprt"), 0);
            ...
            if(CollectionUtils.isEmpty(urlList)){
            	...
            	query.put("etype",ExperimentType.GRO_SEQ.getValue());
...
//        	String url = "http://www.ebi.ac.uk/arrayexpress/experiments/E-GEOD-26284/?query=human+RNA-seq&organism=&array=&exptype[]=&exptype[]http://www.ebi.ac.uk/arrayexpress/experiments/E-GEOD-26284/?query=human+RNA-seq&organism=&array=&exptype[]=&exptype[]=&page=4&pagesize=500";
			...
			for(Element e_table :tables){
				...
				for(int k = 0; k<sampleCount; k++){
		        	...
		        	sample.setEtype(ExperimentType.GRO_SEQ.getValue());
				...
				for(Element ees : ees_right_title){
					if(ees.text().equalsIgnoreCase("Processed")) processed_index = ees_right_title.indexOf(ees);
				}
...
//http://www.ebi.ac.uk/arrayexpress/experiments/search.html?query=human+RNA-seq&organism=&array=&exptype[]=&exptype[]=&page=2&pagesize=25            
            url = "http://www.ebi.ac.uk/arrayexpress/experiments/search.html?query=gro-seq&organism="+fromType+"&array=&exptype[]=&exptype[]=&page="
