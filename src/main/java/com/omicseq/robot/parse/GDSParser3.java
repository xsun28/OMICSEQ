...
//http://www.ncbi.nlm.nih.gov/gds/?term=human+gro-seq
 ...
 * @author zejun.du
 */
public class GDSParser3 extends BaseParser {
...
//    private String term = "(((\"%s\"[PDAT] : \"3000\"[PDAT]) AND \"Homo sapiens\"[Organism]) AND \"strategy chip seq\"[Properties]) AND \"sra gds\"[Filter]&cmd=DetailsSearch";
    ...
    private String term = "(\"humans\"[MeSH Terms] OR \"Homo sapiens\"[Organism] OR human[All Fields]) AND gro-seq[All Fields]";
    @Override
