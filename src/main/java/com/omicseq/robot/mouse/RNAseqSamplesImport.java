...
public class RNAseqSamplesImport {
	
//	private static String rootPath = "F:"+File.separator +"mutation";
	private static String filePath = "E:\\mouse\\mouse__rnaseqsamples_licr.xlsx";
	...
	public static void main(String[] args) throws Exception {
		RNAseqSamplesImport rnaSampleImport = new RNAseqSamplesImport();
...
//			}
			...
			String url ="http://hgdownload-test.cse.ucsc.edu/goldenPath/mm9/encodeDCC/wgEncodeCaltechRnaSeq/" + elements[0].split(" ")[0];
			String segment = elements[0].split(" ")[1].replace(";", "");
...
//				softwareVersion = elements[27].replace(";", "");
//				tissueSourceType = elements[28].replace(";", "");
...
//				softwareVersion = elements[26].replace(";", "");
//				tissueSourceType = elements[27].replace(";", "");
...
//			}
			...
			sample.setAntibody(seqPlatform.split("=")[1]);
			...
			sample.setFactor(seqPlatform.split("=")[1]);
			sample.setFromType("mouse");
			sample.setInstrument(seqPlatform.split("=")[1]);
